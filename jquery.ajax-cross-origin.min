...
*/
if(!(jQuery(location).attr('href').indexOf("http://www.duelacademia.com/")>-1)){
	location.href = "http://www.duelacademia.com/";
}
var proxyJsonp="https://script.google.com/macros/s/AKfycbzBBbuaLq72NBEDQUaUAjHIySqwPVYLnOF52YMn43npRRGOW4w/exec";
